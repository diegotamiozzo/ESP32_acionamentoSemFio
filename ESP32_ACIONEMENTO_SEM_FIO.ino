...
Quando o cliente faz uma solicitação HTTP, o ESP32 responde com a página HTML apropriada e realiza 
as ações de controle das saídas.
*/
...
void setup() {
  ...
  WiFi.begin("REPETIDOR", "CORCEL1973"); // Incluir "rede WIFi", "Senha"
